#############################################################################
# Makefile for building: msgpacker
# Generated by qmake (3.0) (Qt 5.6.0)
# Project:  msgpacker.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile msgpacker.pro
#############################################################################
...
INCPATH       = -I. -I. -I/usr/lib/qt/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = msgpacker1.0.0
DISTDIR = /home/vvv/tests/c/msgpacker/.tmp/msgpacker1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		msgpacker.pro packer.h main.c \
		packer.c
QMAKE_TARGET  = msgpacker
DESTDIR       = 
TARGET        = msgpacker
...
Makefile: msgpacker.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		msgpacker.pro
	$(QMAKE) -o Makefile msgpacker.pro
...
main.o: main.c packer.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o main.o main.c

packer.o: packer.c packer.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o packer.o packer.c
